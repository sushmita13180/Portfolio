...
function Skills() {
  return (
    ...
    <div className="flex flex-col items-center justify-center border-2 shadow-md  min-w-[180px] md:min-w-[200px] rounded-[50%] hover:scale-110 duration-200 ease-in-out cursor-pointer">
    ...
    <div className="flex flex-col items-center justify-center border-2 shadow-md min-w-[180px] md:min-w-[200px] rounded-[50%] p-3 hover:scale-110 duration-200 ease-in-out cursor-pointer">
      <img src="./images/js.png" alt=""  className="w-[90px]"/>
      <p className="font-medium">Javascript</p>
      </div>
    <div className="flex flex-col items-center justify-center border-2 shadow-md min-w-[180px] md:min-w-[200px] p-6 rounded-[50%] hover:scale-110 duration-200 ease-in-out cursor-pointer">
    ...
    <div className="flex flex-col items-center justify-center border-2 shadow-md min-w-[180px] md:min-w-[200px] rounded-[50%] hover:scale-110 duration-200 ease-in-out cursor-pointer">
      ...
      <p className="font-medium">Adobe Photoshop</p>
      </div>
    </div>
